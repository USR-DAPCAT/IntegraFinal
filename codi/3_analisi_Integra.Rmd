...
dades_BASAL_lab<-dades_BASAL_lab %>% refcat(conductor = conductor,ref = "refcat")
...
formu_2<-formula_table1("taula_basal",y="grupIntervencio",taulavariables=conductor,dt=dades_BASAL_lab)


table1::table1(formu_2,
               data = dades_BASAL_lab,caption="TAULA 1.Descriptiva BASAL",
