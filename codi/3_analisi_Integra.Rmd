...
&check; Revisió i depuració errors.Diferències amb Model Article:   <br/>

&check; Tensio Diastolica i Tensió Sistolica,el Grup Sham és Internetion, i a l'inrevés.    <br/>
&check; Falta Lifestyle measures    <br/>
&check; A la "Figure 2.Percentatge of patients in each... the target HbA1c <8 " és diferent!    <br/>
&check; Regressio Lineal Mitjana de la Diferència hba1cFinal-hba1cBasal  amb Cluster és diferent! article:-0.6, R-markdown:-0.65      <br/>
&check; A la "Figure 3.Logistic regression model..." els paràmetres MICRO,MACRO diferents.    <br/>
...
c("ajuste1") %>% 
  ...
  sjPlot::tab_model(digits=3, show.intercept = F,dv.labels = c("M1"),
