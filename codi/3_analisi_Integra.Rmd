...
glm(hba1cNGSP_7~grupIntervencio+edat+sexe_id + duracioDiabetesAnys2+hta_id+dislipemia_id +imc ,family = "binomial",data = dt_temp) %>% 
  parameters::parameters(exp=T)

ramo<-glm(hba1cNGSP_7~grupIntervencio+edat+sexe_id + duracioDiabetesAnys2+hta_id+dislipemia_id +imc ,family = "binomial",data = dt_temp) 
