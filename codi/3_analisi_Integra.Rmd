...
table1::table1(~ hba1cNGSP,
               data = M00%>%filter(grupIntervencio=="Intervention"),caption="Grup Intervenció.Interval Confiança Mitjanes Glicada Basal",
               render.continuous=c(.="N",.="Mean (SD)", .="Median [Min, Max]"),
               render.categorical="FREQ (PCTnoNA%)",
               topclass="Rtable1-zebra")
table1::table1(~ hba1cNGSP,
               data = M12%>%filter(grupIntervencio=="Intervention"),caption="Grup Intervenció.Interval Confiança Mitjanes  Glicada Final",
               render.continuous=c(.="N",.="Mean (SD)", .="Median [Min, Max]"),
               render.categorical="FREQ (PCTnoNA%)",
               topclass="Rtable1-zebra")
...
table1::table1(~ hba1cNGSP,
               data = M00%>%filter(grupIntervencio=="Sham"),caption="Grup Sham.Interval Confiança Mitjanes Glicada Basal",
               render.continuous=c(.="N",.="Mean (SD)", .="Median [Min, Max]"),
               render.categorical="FREQ (PCTnoNA%)",
               topclass="Rtable1-zebra")
table1::table1(~ hba1cNGSP,
               data = M12%>%filter(grupIntervencio=="Sham"),caption="Grup Sham.Interval Confiança Mitjanes  Glicada Final",
               render.continuous=c(.="N",.="Mean (SD)", .="Median [Min, Max]"),
               render.categorical="FREQ (PCTnoNA%)",
               topclass="Rtable1-zebra")
...
```
### 3.7 Regressio Logística Condicional hba1c<7%

```{r Resultats8, include=T}



dt_temp_percent<-dt_temp%>%select(pacient_id,tipus,grupIntervencio,sexe_id,edat,hba1cNGSP_7,hba1cNGSP_8)%>%
  arrange(pacient_id) %>% na.omit()


print("Percentatge de hba1c<7% per Grup Intervenció /Grup Sham per Total/Sexe/edat")
...
# Basic barplot
p0a<-ggplot(data=dt_temp_percent, aes(x=grupIntervencio, y=hba1cNGSP_7)) +
     geom_bar(stat="identity", width=0.3,color="black")+
      labs(title="Freqüència de hba1c>=7% per Grup Intervenció /Grup Sham total", x ="hba1c>=7%", y = "Freqüència valors hba1c>=7%")+
...
# Basic barplot
p0b<-ggplot(data=dt_temp_percent, aes(x=grupIntervencio, y=hba1cNGSP_8)) +
     geom_bar(stat="identity", width=0.3,color="black")+
      labs(title="Freqüència de hba1c>=8% per Grup Intervenció /Grup Sham total", x ="hba1c>=8%", y = "Freqüència valors hba1c>=8%")+
            scale_color_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                   scale_fill_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                     theme_classic()
p0b
...
# Basic barplot
p1<-ggplot(data=dt_temp_percent, aes(x=grupIntervencio, y=hba1cNGSP_7)) +
     geom_bar(stat="identity", width=0.3,color="black")+
      labs(title="Freqüència de hba1c>=7% per Grup Intervenció /Grup Sham per Sexe", x ="hba1c>=7%", y = "Freqüència valors hba1c>=7%")+
          facet_grid(~sexe_id2)+
            scale_color_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                   scale_fill_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                     theme_classic()
...
print("Percentatge de hba1c<8% per Grup Intervenció /Grup Sham per Total/Sexe/edat")

# Basic barplot
p2<-ggplot(data=dt_temp_percent, aes(x=grupIntervencio, y=hba1cNGSP_7)) +
     geom_bar(stat="identity", width=0.3,color="black")+
      labs(title="Freqüència de hba1c>=7% per Grup Intervenció /Grup Sham per Edat", x ="hba1c>=7%", y = "Freqüència valors hba1c>=7%")+
          facet_grid(~edat2)+
            scale_color_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                   scale_fill_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                     theme_classic()
...
# Basic barplot
p3<-ggplot(data=dt_temp_percent, aes(x=grupIntervencio, y=hba1cNGSP_8)) +
     geom_bar(stat="identity", width=0.3,color="black")+
      labs(title="Freqüència de hba1c>=8% per Grup Intervenció /Grup Sham per Sexe", x ="hba1c>=8%", y = "Freqüència valors hba1c>=8%")+
          facet_grid(~sexe_id2)+
            scale_color_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                   scale_fill_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                     theme_classic()
...
# Basic barplot
p4<-ggplot(data=dt_temp_percent, aes(x=grupIntervencio, y=hba1cNGSP_8)) +
     geom_bar(stat="identity", width=0.3,color="black")+
      labs(title="Freqüència de hba1c>=8% per Grup Intervenció /Grup Sham per Edat", x ="hba1c>=8%", y = "Freqüència valors hba1c>=8%")+
          facet_grid(~edat2)+
            scale_color_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                   scale_fill_manual(values=c("#999999", "#E69F00", "#56B4E9"))+
                     theme_classic()
