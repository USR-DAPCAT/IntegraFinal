...
#---------------#
#DT_VISITA_BASAL_lab<-convertir_dates(d=DT_VISITA_HISTORIC_MES0,taulavariables=conductor_variables2)
#---------------#
#DT_VISITA_BASAL_lab<-etiquetar(d=DT_VISITA_BASAL,taulavariables=conductor_variables2)
#---------------#
#DT_VISITA_BASAL_lab<-LAB_ETIQ_v2(dt=DT_VISITA_BASAL_lab,variables_factors=conductor_variables2,fulla="etiquetes0",idioma="etiqueta2")
#---------------#
#DT_VISITA_BASAL_lab
...
#na.action=T
#DT_VISITA_HISTORIC_MES00_lab2<-descrTable(~.,data=DT_VISITA_BASAL_lab,show.p.overall=F,method = 2,Q1=0,Q3=1,max.xlev = 40,show.n=T)
...
#T1<-descrTable(formula_taula_HISTORIC,method = 2,Q1 = 0, Q3 =1 ,show.p.overall = F,data=DT_VISITA_BASAL_lab,max.xlev = 40)
#T1
#---------------#
...
#DT_VISITA_HISTORIC_TABLES<-descrTable(~.,data=DT_VISITA_HISTORIC_FINAL,show.p.overall=F,method = 2,Q1=0,Q3=1,max.xlev = 40)
#names(DT_VISITA_HISTORIC_FINAL)
...
#---------------#
#DT_VISITA_HISTORIC_lab<-convertir_dates(d=DT_VISITA_HISTORIC_FINAL,taulavariables=conductor_variables2)
#---------------#
#DT_VISITA_HISTORIC_lab<-etiquetar(d=DT_VISITA_HISTORIC_FINAL,taulavariables=conductor_variables2)
#---------------#
...
saveRDS(TAULA_PLANA, file=here::here(params$dir_dades_desti,"TAULA_PLANA_lab.rds"))
