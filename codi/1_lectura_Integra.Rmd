...
DT_VISITA_BASAL_lab<-convertir_dates(d=DT_VISITA_BASAL,taulavariables=conductor)
DT_VISITA_BASAL_lab<-etiquetar(d=DT_VISITA_BASAL,taulavariables=conductor)
...
DT_VISITA_HISTORIC_lab<-etiquetar(d=DT_VISITA_HISTORIC_FINAL,taulavariables=conductor)
